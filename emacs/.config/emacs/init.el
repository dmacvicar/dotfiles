...
(autoload 'duncan/generate-diary-from-calendars "ical-vdir-diary" nil t)
...
(use-package dtrt-indent
  ...
  :diminish
  :hook
  ((prog-mode-hook text-mode-hook) . dtrt-indent-mode))
...
(defun duncan/org-element-at-point-silent (orig &rest args)
  ...
  (when (derived-mode-p 'org-mode)
    (apply orig args)))
(advice-add 'org-element-at-point :around #'duncan/org-element-at-point-silent)
;(use-package org-ql
;  :after org)
                                       ...
                                       (setq-local face-remap-cookies
                                                   (mapcar (lambda (remapping)
                                                           ...
                                                           '((default :height 2.5)
                                                             ...
                                                             (org-image-actual-width (* (display-pixel-width) 0.8))
